...
?>
                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <h1 class="mb-0 h3">Hospital Login - Beacon Aid</h1>
                            </div>
    ...
    <footer class="bg-white rounded shadow p-5 mx-4 mb-4 mt-4">
    <div class="row">
        <div class="col-12 col-md-4 col-xl-6 mb-4 mb-md-0">
            <p class="mb-0 text-center text-lg-start"><img src="../assets/logo.png" width="60" /> <a class="text-primary fw-normal" href="#" target="_blank">Beacon Aid</a></p>
        </div>
    </div>
</footer>
</main>
